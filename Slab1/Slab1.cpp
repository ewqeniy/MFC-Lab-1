...
// Slab1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSlab1App, CWinApp)
...
// Единственный объект CSlab1App

CSlab1App theApp;


// инициализация CSlab1App

BOOL CSlab1App::InitInstance()
{
